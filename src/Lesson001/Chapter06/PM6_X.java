...
public class PM6_X {
	...
	static int[] takeNum = new int[19];
	static int maxRoll = 16;
	...
	public static void main(String[] args) {
		...
		System.out.printf("可擲次數:%d 輸入姓名並擲骰子 (Enter 結束) => ",maxRoll);
		name = keyin.nextLine();
		while (name.length() != 0 && maxRoll > 0) {
			game(name);
